...
?>
	...
	if(Dial_Next_Display=='Y')
	   {
	var DiaLControl_manual_HTML = "<a href=\"#\" onclick=\"ManualDialNext('','','','','','0');\"><IMG SRC=\"../agc/images/<?php echo $lang_images_dir; ?>vdc_LB_dialnextnumber_cn.gif\" border=0 alt=\"<?php echo $lang_dial_next_number; ?>\"></a>";
	   }
	else
	  {
			...
			//		alert(xmlhttp.responseText);
					...
					if ( (MDnextCID.match(regMNCvar)) || (MDnextCID.match(regMDFvarDNC)) || (MDnextCID.match(regMDFvarCAMP)) )
						...
						if (starting_dial_level == 0)
							...
							if(Dial_Next_Display=='Y')
								{											
							document.getElementById("DiaLControl").innerHTML = "<a href=\"#\" onclick=\"ManualDialNext('','','','','','0');\"><IMG SRC=\"../agc/images/<?php echo $lang_images_dir; ?>vdc_LB_dialnextnumber_cn.gif\" border=0 alt=\"<?php echo $lang_dial_next_number; ?>\"></a>";
							   }
							else
								{
							document.getElementById("DiaLControl").innerHTML = "";							
			...
			if ( (auto_dial_level == 0) && (dial_method != 'INBOUND_MAN') )
				...
				if (document.vicidial_form.DiaLAltPhonE.checked==true)
					...
					if (hotkeysused == 'YES')
						...
						if(Dial_Next_Display=='Y')
							{
						document.getElementById("DiaLControl").innerHTML = "<a href=\"#\" onclick=\"ManualDialNext('','','','','','0');\"><IMG SRC=\"../agc/images/<?php echo $lang_images_dir; ?>vdc_LB_dialnextnumber_cn.gif\" border=0 alt=\"<?php echo $lang_hangup; ?>\"></a>";
							}
						else
							{
							document.getElementById("DiaLControl").innerHTML = "";					
...
// GLOBAL FUNCTIONS
	...
	function agent_grab_line2(){
		...
		if (xmlhttp) 
			{ 
			RAview_query = "server_ip=" + server_ip + "&session_name=" + session_name + "&ACTION=agent_grab_line2&format=text&user=" + user + "&pass=" + pass + "&conf_exten=" + session_id + "&extension=" + extension + "&prot111ocol=" + protocol + "&campaign=" + campaign + "&stage=100%";
			xmlhttp.open('POST', 'vdc_db_query.php'); 
			xmlhttp.setRequestHeader('Content-Type','application/x-www-form-urlencoded; charset=UTF-8');
			xmlhttp.send(RAview_query); 
			xmlhttp.onreadystatechange = function() 
...
<span style="display:none;position:absolute;left:0px;top:0px;z-index:43;width:100%;" id="AgenTDisablEBoX">
    <table border=1 bgcolor="#FFFFFF" width=<?php echo $CAwidth ?> height=<?php echo $WRheight ?>><TR><TD align=center>你的会话已不可用<BR><a href="#" onClick="LogouT('DISABLED');return false;">注销</a><BR><BR><a href="#" onClick="hideDiv('AgenTDisablEBoX');return false;"><?php echo $lang_return_back; ?></a>
</TD></TR></TABLE>
</span>
...
<table class="agent_info_table" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr style="display:none" >
  ...
  <tr style="display:none">
  <td class="head" style="display:none"><?php echo $lang_phone_number; ?>：
  </td>
  <td style="display:none"><?php echo $SIP_user;?>
  </td>
 </tr>
  <tr style="display:none">
 ...
 <tr>
  <td class="head" colspan=2><?php echo $lang_agent_status; ?>：<span id="status_code"></span>
  </td>
