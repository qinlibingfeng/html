...
// Add by Fnatic 用于向vtiger_search.php传递号码去查询vtigerCRM该号码的详细资料 
	...
	//		var sss = "<?php echo $web_form_address; ?>?iocheck=in&user="+user+"&campaign="+campaign+"&phone="+taskPhoneNumber+"\"";
		//	alert(sss);
			...
			console.log("<iframe onload=\"SetCwinHeight(this)\"  src=\"<?php echo $web_form_address; ?>&iocheck=in&user="+user+"&campaign="+campaign+"&phone="+taskPhoneNumber+"\" style=\"background-color:transparent;\" scrolling=\"auto\" frameborder=\"0\" allowtransparency=\"true\" id=\"popupFrame\" name=\"popupFrame\" width='"+d_w+"' height=\"" + d_h + "\" STYLE=\"z-index:17\"></iframe>")
			}
		}
