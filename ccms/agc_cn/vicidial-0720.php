	...
	// Send Request for allowable campaigns to populate the campaigns pull-down
		...
		function login_user_check(name,status) 
			...
			function login_check(){
				document.getElementById("phone_login").value = document.getElementById("VD_login").value;
				document.getElementById("phone_pass").value = document.getElementById("VD_login").value;
...
echo "</head>\n";
echo "<BODY BGCOLOR=WHITE MARGINHEIGHT=0 MARGINWIDTH=0 style=\"background-color: #EFF8FE; background-repeat:no-repeat;background-position: top center;width=317px;height=228px; background-image:url(../agc/images/lgq_input_div.png)\"  onResize=\"browser_dimensions();\"  onLoad=\"browser_dimensions();\">\n";
...
echo "<INPUT TYPE=hidden ID=phone_login NAME=phone_login VALUE=\"\">\n";
echo "<INPUT TYPE=hidden ID=phone_pass NAME=phone_pass VALUE=\"\">\n";
echo "<TR><TD ALIGN=LEFT COLSPAN=2><font size=1> &nbsp; </TD></TR>\n";
...
echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  NOWRAP><!--<a href=\"../agc_en/vicidial.php?relogin=YES&VD_login=$VD_login&VD_campaign=$VD_campaign&phone_login=$phone_login&phone_pass=$phone_pass&VD_pass=$VD_pass\">English <img src=\"../agc/images/en.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  BGCOLOR=\"#CCFFCC\" NOWRAP><a href=\"../agc_cn/vicidial.php?relogin=YES&VD_login=$VD_login&VD_campaign=$VD_campaign&phone_login=$phone_login&phone_pass=$phone_pass&VD_pass=$VD_pass\">简体中文 <img src=\"../agc/images/cn.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a>--></TD>\n";	echo "</TR></TABLE>\n";
	...
	else
	{
		...
		echo "<script>alert('00000');</script>";
...
//echo "<TABLE WIDTH=100%><TR><TD></TD>\n";
//echo "<!-- ILPV -->\n";
echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  NOWRAP><!--<a href=\"../agc_en/vicidial.php?relogin=YES&VD_login=$VD_login&VD_campaign=$VD_campaign&phone_login=$phone_login&phone_pass=$phone_pass&VD_pass=$VD_pass\">English <img src=\"../agc/images/en.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  BGCOLOR=\"#CCFFCC\" NOWRAP><a href=\"../agc_cn/vicidial.php?relogin=YES&VD_login=$VD_login&VD_campaign=$VD_campaign&phone_login=$VD_login&phone_pass=$VD_pass\&VD_pass=$VD_pass\">简体中文 <img src=\"../agc/images/cn.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a>--></TD>\n";//echo "</TR></TABLE>\n";
...
echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  NOWRAP><!--<a href=\"../agc_en/vicidial.php?relogin=YES&VD_login=$VD_login&VD_campaign=$VD_campaign&phone_login=$phone_login&phone_pass=$phone_pass&VD_pass=$VD_pass\">English <img src=\"../agc/images/en.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  BGCOLOR=\"#CCFFCC\" NOWRAP><a href=\"../agc_cn/vicidial.php?relogin=YES&VD_login=$VD_login&VD_campaign=$VD_campaign&phone_login=$phone_login&phone_pass=$phone_pass&VD_pass=$VD_pass\">简体中文 <img src=\"../agc/images/cn.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a>--></TD>\n";		echo "</TR></TABLE>\n";
	...
	if (strlen($session_id) < 1)
		{
			echo "<script>alert('66666');</script>";
...
-->
	...
	function Phone_Connect_number(){
		
		 //$("#Phone_connect").attr("src","http://172.17.1.90/tongxun/11/index.php");
		 $("#Phone_connect").attr("src","../mail_list/index-1.php");
		 //$("#dialog-confirm11").dialog("open");
	...
	function Phone_Connect_number11(){
		
		 //$("#Phone_connect").attr("src","http://172.17.1.90/tongxun/11/index.php");
		 $("#Phone_connect").attr("src","../mail_list/index-2.php");
		 //$("#dialog-confirm11").dialog("open");
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
	   <td height="37"><input type='checkbox' name='manudial_dial_type' id='manudial_dial_type' title='<?php echo $lang_inline_dial_title; ?>' /> <?php echo $lang_inline_dial; ?><!-- + fnatic 20110627 -->
		   ...
		   <a href="#" onclick="Phone_Connect_number();">通</a>
        <table border="1">
</table>
<tr>
 ...
 <table cellpadding="0" cellspacing="0" border="0" class="transfer_table" align="center">
  <!-- <tr>
   ...
   <fieldset>
    ...
    <div style="margin:2px 2px">
	 <input type="radio" name="btnTransferTarget" id="xferoverride" size="1" value="0" style="vertical-align:text-bottom" onClick="overrideclick()"><a href="#" onclick="target_check(this);Phone_Connect_number11();return false;"><?php echo $lang_outline_phone; ?></a>
	 
	 <span id="overrideinput">
	 <input type="text" size="12" name="xferoutnumber" id="xferoutnumber"  maxlength="25" value="" style="margin-left:10px">
	 </span>
...
<div id="dialog-confirm11" title="通讯录" >

<iframe id="Phone_connect" src="" width="840" height="520"></iframe>
<script type="text/javascript">
if($("#Phone_connect").attr("src") == ""){
	$("#Phone_connect").hide();
}else{
	$("#Phone_connect").show();
}
