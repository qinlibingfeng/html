	...
	function start_all_refresh()
		...
		//	if ( (agentcall_manual != '1') && (starting_dial_level > 0) )
			...
			if ( (crm_popup_login == 'Y') && (crm_login_address.length > 4) )
				...
				if(crm_target=='CCMS')
					{
					document.getElementById("ScriptContents").innerHTML = "<iframe onload=\"SetCwinHeight(this)\"  src=\"" + TEMP_crm_login_address + "\" style=\"background-color:transparent;\"  frameborder=\"0\"  scrolling=\"yes\" allowtransparency=\"true\" id=\"popupFrame\" name=\"popupFrame\" width=\"99%\" height=\"100%" + script_height + "\" STYLE=\"z-index:18\"></iframe>";	
					}
				// end
	...
	function buildDiv(divvar)
		...
		if (document.getElementById(divvar))
			...
			if (divvar == 'DiaLLeaDPrevieW')
				...
				if(Lead_Preview_Display=='Y')
					{				 
				//var buildDivHTML = "<font class=\"preview_text\"> <input style=\"display:none;width:170px\"  type=checkbox name=LeadPreview size=1 value=\"0\">系统工具<BR></font>";
				    }
					else
					{
...
<!--
   ...
   .preview_text {font-size: 12px;  font-family:"宋体"; background: background:rgb(220,220,220);font-weight:bold}
   .preview_text_red {font-size: 12px;  font-family:"宋体"; background-color:rgb(220,220,220)}
...
<tr>
<td id="button_pannel_td" nowrap="nowrap" style="width:100%;">
...
<!--<tr style="background-color:rgb(220,220,220); height:20px; width:100%;"><td>
<?php if($Lead_Preview_Display=='Y'){?>
<input style="display:none;width:170px" type=checkbox name=LeadPreview size=1 value="0">系统工具
<?php } ?>
</td></tr>-->
</span>

<!--<div id="lgq-systemboot" style="width:170px;height:20px">
<tr  style="background-color:rgb(220,220,220); height:20px; width:100%;">
<td>系统工具</td>
</tr>
</div>-->
...
<table width="100%">
<ul style="background-color:rgb(220,220,220); height:20px; width:100%;"><li><font size="2.5">系统工具</font></li></ul>
...
<table width="100%" >
<ul style="background-color:rgb(220,220,220); height:20px; width:100%;"><li><font size="2.5">系统公告</font></li></ul>
<tr><td>
