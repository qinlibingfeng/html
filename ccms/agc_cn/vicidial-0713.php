...
// Send alert control command for agent
	function alert_control(taskalert) 
		...
		if (taskalert=='ON')
			{
			alert_enabled = 'ON';
			document.getElementById("AgentAlertSpan").innerHTML = "<a href=\"#\" onclick=\"alert_control('OFF');return false;\"><?php echo $lang_link_close_inbound_notice; ?></a>";
			}
		else
			{
			alert_enabled = 'OFF';
			document.getElementById("AgentAlertSpan").innerHTML = "<a href=\"#\" onclick=\"alert_control('ON');return false;\"><?php echo $lang_link_open_inbound_notice; ?></a>";
			}
				...
				xmlhttprequestcheckconf.onreadystatechange = function() 
					...
					//document.getElementById("debugbottomspan").innerHTML=xmlhttprequestcheckconf.responseText;
						...
						if ( (callholdstatus == '1') || (agentcallsstatus == '1') || (vicidial_agent_disable != 'NOT_ACTIVE') )
						{
							...
							var lgq_phone_number = check_time_array[25].split("phone_number: ");
							//var lgq_phone_number = lgq_phone_number_array[9];
							//alert(lgq_phone_number);
							...
							if (CamPCalLs != 'N')
								...
								if(CamPCalLs.indexOf("SIP")>0){
									...
									//alert(lgq_phone_number);
									document.getElementById("AgentStatusCalls").innerHTML = CamPCalLs.substr(0,CamPCalLs.indexOf("SIP"))+lgq_phone_number; //cn bug
								}else{
									//alert(lgq_phone_number);
									document.getElementById("AgentStatusCalls").innerHTML = CamPCalLs+lgq_phone_number;
								}
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	alert(xmlhttp.responseText);
					...
					if (CBcounT == 0) {var CBprint = "";}
						...
						document.getElementById("CBstatusSpan").innerHTML ="<a href=\"#\" onclick=\"CalLBacKsLisTCheck();return false;\"><?php echo $lang_link_agent_callback_notice; ?>" + CBprint + "</a>";
	...
	function AgentsViewOpen(AVlocation,AVoperation)
		...
		if (AVoperation=='open')
			...
			if (AVlocation=='AgentViewSpan')
				...
				document.getElementById("AgentViewLink").innerHTML = "<a href=\"#\" onclick=\"redirectcalltoagentid = '';AgentsViewOpen('AgentViewSpan','open');return false;\"><?php echo $lang_link_agent_status; ?></a>";
	...
	function start_all_refresh()
		...
		//	if ( (agentcall_manual != '1') && (starting_dial_level > 0) )
			...
			if ( (crm_popup_login == 'Y') && (crm_login_address.length > 4) )
				...
				if(crm_target=='CCMS')
					{
					document.getElementById("ScriptContents").innerHTML = "<iframe onload=\"SetCwinHeight(this)\"  src=\"" + TEMP_crm_login_address + "\" style=\"background-color:transparent;\"  frameborder=\"0\"  scrolling=\"yes\" allowtransparency=\"true\" id=\"popupFrame\" name=\"popupFrame\" width=\"99%\" height=\"88%" + script_height + "\" STYLE=\"z-index:18\"></iframe>";	
					}
				// end
...
<!--
   ...
   .preview_text_red {font-size: 12px;  font-family:"宋体"; background:rgb(220,220,220)}
   ...
   div.button_link a:hover,div.button_link a:active{background-color:#FF6600;color:blue;}
  ...
  <TD class="banner_text_2" COLSPAN=4  VALIGN=TOP ALIGN=RIGHT style="background:url(../agc/images/logo_r1_c3.jpg); background-repeat:repeat-x;text-algin:left;">
    <b><span style="color:#FFFFFF; font-size:12px; font-family:Arial, Helvetica, sans-serif;" id="status">LIVE</span></b>&nbsp;
     <font class="banner_text">
	  ...
	  <a href="#" onClick="changepassword();return false;"><?php echo $lang_link_change_password; ?></a>&nbsp;&nbsp;
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
	   <td height="37"><input type='checkbox' name='manudial_dial_type' id='manudial_dial_type' title='<?php echo $lang_inline_dial_title; ?>' /> <?php echo $lang_inline_dial; ?><!-- + fnatic 20110627 -->
		   ...
		   <a href="#" onclick="CalLBacKsLisTCheck();return false;">通</a>
        <table border="1">
</table>
<tr>
...
<span style="position:absolute;left:0px;top:0px;z-index:45;width:100%;height:100%" id="LogouTBox">
    <table border=1 bgcolor="#FFFFFF" width=<?php echo $CAwidth ?> height="100%"><TR><TD align=center><BR><span id="LogouTBoxLink">注销</span></TD></TR></TABLE>
</span>
...
<span style="position:absolute;left:0px;top:0px;z-index:53;width:100%;" id="CloserSelectBox">
    <table border=1 bgcolor="#F4F4F4"  height=<?php echo $WRheight ?> width=<?php echo $CAwidth ?>><TR><TD align=center VALIGN=top>请选择技能组 <BR>
...
<a href="#" onClick="ManualDialNext('','','','','','0');"><IMG style="display:none"  SRC="../agc/images/vdc_LB_dialnextnumber_OFF_cn.gif" border=0 alt="拨下一个号码"></a>
<?php } ?>
</span>
<BR>
...
<span id="XferControl"><?php if ($VU_vicidial_transfers == '1'){?><IMG SRC="../agc/images/<?php echo $lang_images_dir; ?>vdc_LB_transferconf_OFF_cn.gif" border=0 alt="转接"><?php }?></span><BR>
...
<span STYLE="background-color: #FFFFFF" id="WebFormSpan"><IMG SRC="../agc/images/<?php echo $lang_images_dir; ?>vdc_LB_webform_OFF_cn.gif" border=0 alt="<?php echo $lang_web_form ; ?>"></span>
<?php
if ($enable_second_webform > 0)
	{echo "<span STYLE=\"background-color: #FFFFFF\" id=\"WebFormSpanTwo\"><IMG SRC=\"../agc/images/" . $lang_images_dir . "vdc_LB_webform_two_OFF_cn.gif\" border=0 alt=\"" . $lang_web_form . " 2\"></span>\n";}
?>
...
<ul <?php if($VU_view_agent_status == 'N'){ echo " style=\"display:none;\""; }?>>
	<li>
...
<table width="100%">
<ul style="background-color:rgb(220,220,220); height:auto; width:77%;"><li><font size="2.5"><?php echo $lang_notice; ?></font></li></ul>
<tr><td>
...
<table class="agent_info_table" border="0" cellspacing="0" cellpadding="0" width="100%">
 <tr>
  <td class="head" colspan=2><?php echo $lang_account; ?>：
  <?php echo $VD_login;?>
  </td>
 </tr>
  <tr>
...
<iframe id="webaddress" src="" width="780" height="480"></iframe>
<script type="text/javascript">
if($("#webaddress").attr("src") == ""){
	$("#webaddress").hide();
}else{
	$("#webaddress").show();
}
