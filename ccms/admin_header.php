...
if ($hh=='remoteagentgroups_hh') 
	{$remoteagentgroups_hh="bgcolor=\"$remoteagent_color\""; $remoteagent_fc="$remoteagent_font"; $remoteagent_bold="$header_selected_bold";}
	else {$remoteagentgroups_hh=''; $remoteagent_fc='BLACK'; $remoteagent_bold="$header_nonselected_bold";}
if ($hh=='usergroups') 
...
">Load New Leads</a></div> -->
    ...
    <div><img src="./new_style/images/empty.gif" /></div>
		...
		<div id="left_menu"><a href="<?php echo $ADMIN ?>?ADD=201315" class="white">Remote Groups</a></div>

	<?php
	if (strlen($remoteagentgroups_hh) > 1) 
		{ 
		?>
        
		<div id="left_line"><a href="<?php echo $ADMIN ?>?ADD=201315">Show Remote Agent Groups</a></div>
	
		<div id="left_line"><a href="<?php echo $ADMIN ?>?ADD=201319">Add New Remote Agent Groups</a></div>
