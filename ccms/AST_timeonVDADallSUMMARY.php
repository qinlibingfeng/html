...
$STARTtime = date("U");
$stmt="SELECT user_level from vicidial_users where user='$PHP_AUTH_USER' and pass='$PHP_AUTH_PW' and user_level > 6 and view_reports='1';";
if ($DB) {echo "|$stmt|\n";}
$rslt=mysql_query($stmt, $link);
$row=mysql_fetch_row($rslt);
$user_level=$row[0];
//$stmt="select campaign_id from vicidial_campaigns where active='Y';";
$stmt = getCampaignSql($user_level,$PHP_AUTH_USER);
...
<HTML>
<HEAD>
<link rel=stylesheet href="./real_time_all_campaigns_summary.css" type="text/css"> 
...
echo "<TD ALIGN=RIGHT><font size=2><B>Call Result:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALstatuses &nbsp; &nbsp; </TD>";
echo "</TR>";
