...
if ($agi instanceof AGI)
	...
	if (strlen($callerid)<=6 && strlen($dnid)>=8)
		{
		$stmt = "SELECT vicidial_live_agents.conf_exten,vicidial_live_agents.status,vicidial_live_agents.campaign_id,vicidial_live_agents.server_ip,vicidial_live_agents.user,vicidial_campaigns.inbound_mode from vicidial_live_agents, vicidial_campaigns where vicidial_live_agents.extension like '%$extension%' and vicidial_campaigns.campaign_id = vicidial_live_agents.campaign_id";
