...
<div id="main"><img src="ccms/images/welcome_r1_c1.jpg" /></div>
<div id="main">
	<div id="left"></div><div id="center">
		<div id="pic"><a href="#" target="_blank" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','ccms/images/welcome_r3_c2-1.jpg',1)" onclick="openWin();return false;"><img src="ccms/images/welcome_r3_c2.jpg" name="Image2" width="281" height="204" border="0" id="Image2" /></a></div>
		...
		<div id="pic3"><a href="#" target="_blank" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','ccms/images/welcome_r3_c6-1.jpg',1)" onclick="openAdmin();return false;"><img src="ccms/images/welcome_r3_c6.jpg" name="Image4" width="281" height="204" border="0" id="Image4" /></a></div>
...
<p><img src="images/IE8_sm.png" width="20px"/>&nbsp;&nbsp;Microsoft Internet Explorer 6.0 ~ 8.0 (<a href="http://www.microsoft.com/download/en/ie.aspx?q=internet+explorer" target="_blank" style="color:#000000;font-weight:bold;">Download</a>)</p>
</div>
</body>
</html>
