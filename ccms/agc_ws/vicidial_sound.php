	...
	//	conf_dialed=1;
		...
		if (xmlhttpXF) 
			...
			if (taskvar == 'FROMParK')
				...
				document.getElementById("ParkControl").innerHTML ="<a href=\"#\" onclick=\"mainxfer_send_redirect('ParK','" + redirectdestination + "','" + redirectdestserverip + "');return false;\"><IMG SRC=\"../agc/images/vdc_LB_parkcall_cn.gif\" border=0 alt=\"保持电话\"></a>";
				//转接按钮可以用
				if (VU_vicidial_transfers == '1'){
						...
						if (taskCheckOR == 'YES')
							...
							if ( (MDchannel.match(regMDL)) && (asterisk_version != '1.0.8') && (asterisk_version != '1.0.9') )
                               ...
                               // alert(XD_live_customer_call);  answered call 
								...
								document.getElementById("ParkControl").innerHTML ="<a href=\"#\" onclick=\"mainxfer_send_redirect('ParK','" + lastcustchannel + "','" + lastcustserverip + "');return false;\"><IMG SRC=\"../agc/images/vdc_LB_parkcall_cn.gif\" border=0 alt=\"保持电话\"></a>";
