...
echo "<TR><TD ALIGN=RIGHT>分机号码: </TD>";
...
echo "<TR><TD ALIGN=CENTER COLSPAN=2><INPUT TYPE=Submit NAME=确认 VALUE=确认> &nbsp; \n";
echo "<span id=\"LogiNReseT\"><INPUT TYPE=BUTTON VALUE=\"刷新Campaign\" OnClick=\"login_allowable_campaigns()\"></span></TD></TR>\n";
...
echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  NOWRAP><!--<a href=\"../agc_en/vicidial.php?relogin=YES&VD_login=$VD_login&VD_campaign=$VD_campaign&phone_login=$phone_login&phone_pass=$phone_pass&VD_pass=$VD_pass\">English <img src=\"../agc/images/en.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  BGCOLOR=\"#CCFFCC\" NOWRAP><a href=\"../agc_cn/vicidial.php?relogin=YES&VD_login=$VD_login&VD_campaign=$VD_campaign&phone_login=$phone_login&phone_pass=$phone_pass&VD_pass=$VD_pass\">简体中文 <img src=\"../agc/images/cn.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a>--></TD>\n";	echo "</TR></TABLE>\n";
	...
	echo "<CENTER><BR><B>话务员帐号</B><BR><BR>";
...
//		$password=strtoupper($VD_pass);
		...
		if ( ( (ereg("START|ALL",$shift_enforcement)) and (!ereg("OFF",$VU_agent_shift_enforcement_override)) ) or (ereg("START|ALL",$VU_agent_shift_enforcement_override)) )
			...
			if ( ($shift_ok < 1) and ($VU_shift_override_flag < 1) and ($VDloginDISPLAY > 0) )
				...
				$VDdisplayMESSAGE.= "<INPUT TYPE=Submit NAME=确认 VALUE=确认></FORM>\n";
				}
			}
...
echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  NOWRAP><!--<a href=\"../agc_en/vicidial.php?relogin=YES&VD_login=$VD_login&VD_campaign=$VD_campaign&phone_login=$phone_login&phone_pass=$phone_pass&VD_pass=$VD_pass\">English <img src=\"../agc/images/en.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  BGCOLOR=\"#CCFFCC\" NOWRAP><a href=\"../agc_cn/vicidial.php?relogin=YES&VD_login=$VD_login&VD_campaign=$VD_campaign&phone_login=$phone_login&phone_pass=$phone_pass&VD_pass=$VD_pass\">简体中文 <img src=\"../agc/images/cn.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a>--></TD>\n";			echo "</TR></TABLE>\n";
			...
			echo "<INPUT TYPE=Submit NAME=确认 VALUE=确认> &nbsp; \n";
		...
		if($CAMPactive>0)
			...
			$stmt="SELECT status,status_name FROM vicidial_campaign_statuses WHERE $selectableSQL status != 'NEW' and binary campaign_id='$VD_campaign' order by status limit 80;";
			$rslt=mysql_query($stmt, $link);
...
echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  NOWRAP><!--<a href=\"../agc_en/vicidial.php?relogin=YES&VD_login=$VD_login&VD_campaign=$VD_campaign&phone_login=$phone_login&phone_pass=$phone_pass&VD_pass=$VD_pass\">English <img src=\"../agc/images/en.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  BGCOLOR=\"#CCFFCC\" NOWRAP><a href=\"../agc_cn/vicidial.php?relogin=YES&VD_login=$VD_login&VD_campaign=$VD_campaign&phone_login=$phone_login&phone_pass=$phone_pass&VD_pass=$VD_pass\">简体中文 <img src=\"../agc/images/cn.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a>--></TD>\n";	echo "</TR></TABLE>\n";
	...
	echo "<TR><TD ALIGN=RIGHT>分机密码:  </TD>";
	echo "<TD ALIGN=LEFT><INPUT TYPE=PASSWORD NAME=phone_pass SIZE=10 maxlength=20 VALUE=\"$phone_pass\"></TD></TR>\n";
	echo "<TR><TD ALIGN=CENTER COLSPAN=2><INPUT TYPE=Submit NAME=确认 VALUE=确认></TD></TR>\n";
	echo "<TR><TD ALIGN=LEFT COLSPAN=2><font size=1><BR></TD></TR>\n";
	echo "</TABLE>\n";
	echo "</FORM>\n\n";
	echo "</body>\n\n";
...
?>
	...
	var DiaLControl_auto_HTML = "<IMG SRC=\"../agc/images/vdc_LB_pause_OFF_cn.gif\" border=0 alt=\" 暂停 \"><a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADready');\"><IMG SRC=\"../agc/images/vdc_LB_resume_cn.gif\" border=0 alt=\"恢复\"></a>";
	var DiaLControl_auto_HTML_ready = "<a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADpause');\"><IMG SRC=\"../agc/images/vdc_LB_pause_cn.gif\" border=0 alt=\" 暂停 \"></a><IMG SRC=\"../agc/images/vdc_LB_resume_OFF_cn.gif\" border=0 alt=\"恢复\">";
	var DiaLControl_auto_HTML_OFF = "<IMG SRC=\"../agc/images/vdc_LB_pause_OFF_cn.gif\" border=0 alt=\" 暂停 \"><IMG SRC=\"../agc/images/vdc_LB_resume_OFF_cn.gif\" border=0 alt=\"恢复\">";
	var DispoSelectBoxStatus = 0;
	var Ring_Uniqueid_old = "";
	//Mod by fnatic start
	if(Dial_Next_Display=='Y')
	   {
	var DiaLControl_manual_HTML = "<a href=\"#\" onclick=\"ManualDialNext('','','','','','0');\"><IMG SRC=\"../agc/images/vdc_LB_dialnextnumber_cn.gif\" border=0 alt=\"拨下一个号码\"></a>";
	   }
	else
	  {
	...
	var image_livecall_OFF = new Image();
		image_livecall_OFF.src="../agc/images/agc_live_call_OFF_cn.gif";
	var image_livecall_ON = new Image();
		image_livecall_ON.src="../agc/images/agc_live_call_ON_cn.gif";
	var image_livecall_DEAD = new Image();
		image_livecall_DEAD.src="../agc/images/agc_live_call_DEAD_cn.gif";
	var image_LB_dialnextnumber = new Image();
		image_LB_dialnextnumber.src="../agc/images/vdc_LB_dialnextnumber_cn.gif";
	var image_LB_hangupcustomer = new Image();
		image_LB_hangupcustomer.src="../agc/images/vdc_LB_hangupcustomer_cn.gif";
	var image_LB_transferconf = new Image();
		image_LB_transferconf.src="../agc/images/vdc_LB_transferconf_cn.gif";
	var image_LB_grabparkedcall = new Image();
		image_LB_grabparkedcall.src="../agc/images/vdc_LB_grabparkedcall_cn.gif";
	var image_LB_parkcall = new Image();
		image_LB_parkcall.src="../agc/images/vdc_LB_parkcall_cn.gif";
	var image_LB_webform = new Image();
		image_LB_webform.src="../agc/images/vdc_LB_webform_cn.gif";
	...
	var image_LB_pause = new Image();
		image_LB_pause.src="../agc/images/vdc_LB_pause_cn.gif";
	var image_LB_resume = new Image();
		image_LB_resume.src="../agc/images/vdc_LB_resume_cn.gif";
	...
	var image_LB_dialnextnumber_OFF = new Image();
		image_LB_dialnextnumber_OFF.src="../agc/images/vdc_LB_dialnextnumber_OFF_cn.gif";
	var image_LB_hangupcustomer_OFF = new Image();
		image_LB_hangupcustomer_OFF.src="../agc/images/vdc_LB_hangupcustomer_OFF_cn.gif";
	var image_LB_transferconf_OFF = new Image();
		image_LB_transferconf_OFF.src="../agc/images/vdc_LB_transferconf_OFF_cn.gif";
	...
	var image_LB_parkcall_OFF = new Image();
		image_LB_parkcall_OFF.src="../agc/images/vdc_LB_parkcall_OFF_cn.gif";
	var image_LB_webform_OFF = new Image();
		image_LB_webform_OFF.src="../agc/images/vdc_LB_webform_OFF_cn.gif";
	...
	var image_LB_pause_OFF = new Image();
		image_LB_pause_OFF.src="../agc/images/vdc_LB_pause_OFF_cn.gif";
	var image_LB_resume_OFF = new Image();
		image_LB_resume_OFF.src="../agc/images/vdc_LB_resume_OFF_cn.gif";
	...
	function volume_control(taskdirection,taskvolchannel,taskagentmute) 
		...
		if (taskagentmute=='AgenT')
			...
			if (taskdirection=='MUTING')
				{
				document.getElementById("AgentMuteSpan").innerHTML = "<a href=\"#CHAN-" + agentchannel + "\" onclick=\"volume_control('UNMUTE','" + agentchannel + "','AgenT');return false;\"><IMG SRC=\"../agc/images/vdc_volume_UNMUTE_cn.gif\" BORDER=0></a>";
				}
			else
				{
				document.getElementById("AgentMuteSpan").innerHTML = "<a href=\"#CHAN-" + agentchannel + "\" onclick=\"volume_control('MUTING','" + agentchannel + "','AgenT');return false;\"><IMG SRC=\"../agc/images/vdc_volume_MUTE_cn.gif\" BORDER=0></a>";
				}
			}
	...
	function SendManualDial(taskFromConf)
		...
		try{
			...
			if(Xfer_Dial_With_Customer_Display=='Y')
				{
			document.getElementById("DialWithCustomer").innerHTML ="<IMG SRC=\"../agc/images/vdc_XB_dialwithcustomer_OFF_cn.gif\" border=0 alt=\"不挂断拨号\" style=\"vertical-align:middle\"></a>";
                }
			//Mod by fnatic end
			document.getElementById("ParkCustomerDial").innerHTML ="<IMG SRC=\"../agc/images/vdc_XB_parkcustomerdial_OFF_cn.gif\" border=0 alt=\"保持客户拨号\" style=\"vertical-align:middle\"></a>";
			document.getElementById("DialBlindTransfer").innerHTML = "<IMG SRC=\"../agc/images/vdc_XB_blindtransfer_OFF_cn.gif\" border=0 alt=\"盲转\" style=\"vertical-align:middle\">";
	...
	function basic_originate_call(tasknum,taskprefix,taskreverse,taskdialvalue,tasknowait,taskconfxfer,taskcid,taskusegroupalias) 
		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//		document.getElementById("HangupXferLine").innerHTML ="<a href=\"#\" onclick=\"xfercall_send_hangup();return false;\"><IMG SRC=\"../agc/images/vdc_XB_hangupxferline_cn.gif\" border=0 alt=\"挂断第三方转接线\"></a>";
						}
						xmlhttp = null;
						CollectGarbage();
					}
	...
	//	conf_dialed=1;
		...
		if (xmlhttpXF) 
			...
			if (taskvar == 'ParK')
				...
				park_on_extension = "8900*CCMS_CSAT";
				...
				document.getElementById("ParkControl").innerHTML ="<a href=\"#\" onclick=\"mainxfer_send_redirect('FROMParK','" + redirectdestination + "','" + redirectdestserverip + "');return false;\"><IMG SRC=\"../agc/images/vdc_LB_grabparkedcall_cn.gif\" border=0 alt=\"接起\"></a>";
				//当按了"保持电话"时，转接按钮不可用
				if (VU_vicidial_transfers == '1'){
					document.getElementById("XferControl").innerHTML = "<IMG SRC=\"../agc/images/vdc_LB_transferconf_OFF_cn.gif\" border=0 alt=\"转接\">";
				}
				//hideDiv('TransferMain');
				//$("#TransferMainDIV").dialog("close");
				customerparked=1;
				}
				//#####################seven park agent start###########
			if (taskvar == 'ParKAgent')
				{
				if (CalLCID.length < 1)
					{
					CalLCID = MDnextCID;
				...
				var parkedby = protocol + "/" + extension;
				park_on_extension = "8900*CCMS_CSAT";
				xferredirect_query = "server_ip=" + server_ip + "&session_name=" + session_name + "&user=" + user + "&pass=" + pass + "&ACTION=RedirectToPark&format=text&channel=" + redirectdestination + "&call_server_ip=" + redirectdestserverip + "&queryCID=" + queryCID + "&exten=" + park_on_extension + "&ext_context=" + ext_context + "&ext_priority=1&extenName=agentpark&parkedby=" + parkedby + "&session_id=" + session_id + "&CalLCID=" + CalLCID;
                //alert(taskvar+"|"+taskxferconf+"|"+taskserverip);
				alert(xferredirect_query);
                //alert(redirectdestination+" || "+redirectdestserverip);
				document.getElementById("ParkControl").innerHTML ="<a href=\"#\" onclick=\"mainxfer_send_redirect('FROMParK','" + redirectdestination + "','" + redirectdestserverip + "');return false;\"><IMG SRC=\"../agc/images/vdc_LB_grabparkedcall_cn.gif\" border=0 alt=\"接起\"></a>";
			...
			if (taskvar == 'FROMParK')
				...
				document.getElementById("ParkControl").innerHTML ="<a href=\"#\" onclick=\"mainxfer_send_redirect('ParKAgent','" + redirectdestination + "','" + redirectdestserverip + "');return false;\"><IMG SRC=\"../agc/images/vdc_LB_parkcall_cn.gif\" border=0 alt=\"保持电话\"></a>";
				//转接按钮可以用
				if (VU_vicidial_transfers == '1'){
					document.getElementById("XferControl").innerHTML = "<a href=\"#\" onclick=\"ShoWTransferMain('ON');\"><IMG SRC=\"../agc/images/vdc_LB_transferconf_cn.gif\" border=0 alt=\"转接 - 电话会议\"></a>";
				}
				customerparked=0;
				}
			...
			if (xmlhttp) 
				...
				xmlhttp.onreadystatechange = function() 
					...
					//	alert(xmlhttp.responseText);
						...
						var loop_ct=0;
						var conv_start=0;
						var CB_HTML = "<table width=100% border=0 cellspacing=1 cellpadding=1><tr bgcolor='#CCCCCC'><td>#</td><td>回拨时间</td><td>电话号码</td><td>状态</td><td>CAMPAIGN</td><td>最后通话时间</td><td>备注</td></tr>"
	...
	function NeWManuaLDiaLCalLSubmiT(tempDiaLnow)
		...
		*/
		...
		if(manudial_dial_type == "internal"){
			document.getElementById('MDPhonENumbeR').value = "9399909*" + phone_temp + "*in";;
		}
					...
					//		alert("channel not found yet:\n" + campaign);
						...
						if (taskCheckOR == 'YES')
							...
							if ( (XDchannel.match(regMDL)) && (asterisk_version != '1.0.8') && (asterisk_version != '1.0.9') && (MD_ring_secondS < 10) )
								...
								if(Xfer_Dial_With_Customer_Display=='Y')
									{
								document.getElementById("DialWithCustomer").innerHTML ="<IMG SRC=\"../agc/images/vdc_XB_dialwithcustomer_OFF_cn.gif\" border=0 alt=\"不挂断拨号\" style=\"vertical-align:middle\">";
									}
                                //Mod by fnatic end
								document.getElementById("ParkCustomerDial").innerHTML ="<IMG SRC=\"../agc/images/vdc_XB_parkcustomerdial_OFF_cn.gif\" border=0 alt=\"保持客户拨号\" style=\"vertical-align:middle\">";
							...
							if ( (MDchannel.match(regMDL)) && (asterisk_version != '1.0.8') && (asterisk_version != '1.0.9') )
                               ...
                               // alert(XD_live_customer_call);  answered call 
								...
								document.getElementById("ParkControl").innerHTML ="<a href=\"#\" onclick=\"mainxfer_send_redirect('ParKAgent','" + lastcustchannel + "','" + lastcustserverip + "');return false;\"><IMG SRC=\"../agc/images/vdc_LB_parkcall_cn.gif\" border=0 alt=\"保持电话\"></a>";

								document.getElementById("HangupControl").innerHTML = "<a href=\"#\" onclick=\"dialedcall_send_hangup();\"><IMG SRC=\"../agc/images/vdc_LB_hangupcustomer_cn.gif\" border=0 alt=\"挂断\"></a>";
								if (VU_vicidial_transfers == '1'){
									document.getElementById("XferControl").innerHTML = "<a href=\"#\" onclick=\"ShoWTransferMain('ON');\"><IMG SRC=\"../agc/images/vdc_LB_transferconf_cn.gif\" border=0 alt=\"转接 - 电话会议\"></a>";
                                }
								//Mod by fnatic start
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	alert(xmlhttp.responseText);
					...
					if (UDresponse_status == 'GOOD')
						...
						document.getElementById("WebFormSpan").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address + "\" target=\"" + web_form_target + "\" onMouseOver=\"WebFormRefresH();\"><IMG SRC=\"../agc/images/vdc_LB_webform_cn.gif\" border=0 alt=\"网页表单\"></a>\n";
						if (enable_second_webform > 0)
							{
							document.getElementById("WebFormSpanTwo").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address_two + "\" target=\"" + web_form_target + "\" onMouseOver=\"WebFormTwoRefresH();\"><IMG SRC=\"../agc/images/vdc_LB_webform_two_cn.gif\" border=0 alt=\"网页表单2\"></a>\n";
							}
						}
                        //Modified by Kelvin End
...
// Send the Manual 拨下一个号码 request
	function ManualDialNext(mdnCBid,mdnBDleadid,mdnDiaLCodE,mdnPhonENumbeR,mdnStagE,mdVendorid,mdgroupalias)
		...
		if (dial_method == "INBOUND_MAN")
			...
			if(Dial_Next_Display=='Y')
				{				   
			document.getElementById("DiaLControl").innerHTML = "<IMG SRC=\"../agc/images/vdc_LB_pause_OFF_cn.gif\" border=0 alt=\" 暂停 \"><IMG SRC=\"../agc/images/vdc_LB_resume_OFF_cn.gif\" border=0 alt=\"恢复\"><BR><IMG SRC=\"../agc/images/vdc_LB_dialnextnumber_OFF_cn.gif\" border=0 alt=\"拨下一个号码\">";
			    }
				else
				{		
			document.getElementById("DiaLControl").innerHTML = "<IMG SRC=\"../agc/images/vdc_LB_pause_OFF_cn.gif\" border=0 alt=\" 暂停 \"><IMG SRC=\"../agc/images/vdc_LB_resume_OFF_cn.gif\" border=0 alt=\"恢复\">";			
				}
			//Mod by fnaitc end
		    ...
		    if(Dial_Next_Display=='Y')	
				{
			document.getElementById("DiaLControl").innerHTML = "<IMG SRC=\"../agc/images/vdc_LB_dialnextnumber_OFF_cn.gif\" border=0 alt=\"拨下一个号码\">";
				}
			else
				{
			...
			//		alert(xmlhttp.responseText);
					...
					if ( (MDnextCID.match(regMNCvar)) || (MDnextCID.match(regMDFvarDNC)) || (MDnextCID.match(regMDFvarCAMP)) )
						...
						if (starting_dial_level == 0)
							...
							if(Dial_Next_Display=='Y')
								{											
							document.getElementById("DiaLControl").innerHTML = "<a href=\"#\" onclick=\"ManualDialNext('','','','','','0');\"><IMG SRC=\"../agc/images/vdc_LB_dialnextnumber_cn.gif\" border=0 alt=\"拨下一个号码\"></a>";
							   }
							else
								{
							document.getElementById("DiaLControl").innerHTML = "";							
							...
							if (dial_method == "INBOUND_MAN")
                                ...
                                if(Dial_Next_Display=='Y')
									{
								document.getElementById("DiaLControl").innerHTML = "<IMG SRC=\"../agc/images/vdc_LB_pause_OFF_cn.gif\" border=0 alt=\" 暂停 \"><a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADready');\"><IMG SRC=\"../agc/images/vdc_LB_resume_cn.gif\" border=0 alt=\"恢复\"></a><BR><a href=\"#\" onclick=\"ManualDialNext('','','','','','0');\"><IMG SRC=\"../agc/images/vdc_LB_dialnextnumber_cn.gif\" border=0 alt=\"拨下一个号码\"></a>";
								    }
							    else
									{
					...
					//	CalL_ScripT_id									= MDnextResponse_array[37];
						...
						if (enable_second_webform > 0)
							{
							document.getElementById("WebFormSpanTwo").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address_two + "\" target=\"" + web_form_target + "\" onMouseOver=\"WebFormTwoRefresH();\"><IMG SRC=\"../agc/images/vdc_LB_webform_two_cn.gif\" border=0 alt=\"网页表单 2\"></a>\n";
							}
						}
                        //Modified by Kelvin End
	...
	function AutoDial_ReSume_PauSe(taskaction,taskagentlog,taskwrapup,taskstatuschange,temp_reason)
		...
		if (taskaction == 'VDADready')
			...
			if (dial_method == "INBOUND_MAN")
                ...
                if(Dial_Next_Display=='Y')
					{
				document.getElementById("DiaLControl").innerHTML = "<a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADpause');\"><IMG SRC=\"../agc/images/vdc_LB_pause_cn.gif\" border=0 alt=\" 暂停 \"></a><IMG SRC=\"../agc/images/vdc_LB_resume_OFF_cn.gif\" border=0 alt=\"恢复\"></a><BR><a href=\"#\" onclick=\"ManualDialNext('','','','','','0');\"><IMG SRC=\"../agc/images/vdc_LB_dialnextnumber_cn.gif\" border=0 alt=\"拨下一个号码\"></a>";
				    }
				else
					{
				document.getElementById("DiaLControl").innerHTML = "<a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADpause');\"><IMG SRC=\"../agc/images/vdc_LB_pause_cn.gif\" border=0 alt=\" 暂停 \"></a><IMG SRC=\"../agc/images/vdc_LB_resume_OFF_cn.gif\" border=0 alt=\"恢复\"></a>";								
				    }
				//Mod by fnatic end
					...
					//	alert(xmlhttprequestcheckauto.responseText);
						...
						if (check_VDIC_array[0] == '1')
							...
							if ( (VDIC_data_VDFR[1].length > 1) && (VDCL_fronter_display == 'Y') )
								{VDIC_fronter = " 来自: " + VDIC_data_VDFR[0] + " " + VDIC_data_VDFR[1];}
						...
						//	DialLog("start");
							...
							document.getElementById("HangupControl").innerHTML = "<a href=\"#\" onclick=\"dialedcall_send_hangup();\"><IMG SRC=\"../agc/images/vdc_LB_hangupcustomer_cn.gif\" border=0 alt=\"挂断\"></a>";
							if (VU_vicidial_transfers == '1'){
								document.getElementById("XferControl").innerHTML = "<a href=\"#\" onclick=\"ShoWTransferMain('ON');\"><IMG SRC=\"../agc/images/vdc_LB_transferconf_cn.gif\" border=0 alt=\"转接\"></a>";
							}
							//Add by fnatic start
							if(Xfer_Local_Closer_Display=='Y')
								{
							...
							if (alert_enabled=='ON')
								...
								<?php
									if($phone_place_enable == 'Y'){
								?>
								phone_location_str_alert(callnum," 主叫: " + dial_display_number,"<br> 技能组: " + VDIC_data_VDIG[1] + "<br> " + VDIC_fronter + "<br>" + extension_info,"<?php echo $VD_campaign; ?>");
								<?php
									}else{
								?>
...
// refresh the content of the web form URL
	function WebFormRefresH(taskrefresh,submittask,force_webvars_refresh) 
		...
		if (taskrefresh == 'OUT')
			{
			document.getElementById("WebFormSpan").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address + "\" target=\"" + web_form_target + "\" onMouseOver=\"WebFormRefresH('IN');\"><IMG SRC=\"../agc/images/vdc_LB_webform_cn.gif\" border=0 alt=\"网页表单\"></a>\n";
			}
		else 
			{
			document.getElementById("WebFormSpan").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address + "\" target=\"" + web_form_target + "\" onMouseOut=\"WebFormRefresH('OUT');\"><IMG SRC=\"../agc/images/vdc_LB_webform_cn.gif\" border=0 alt=\"网页表单\"></a>\n";
			}
		}
		}
		//Modified by Kelvin End
...
// refresh the content of the second web form URL
	function WebFormTwoRefresH(taskrefresh,submittask) 
		...
		if (enable_second_webform > 0 )
			...
			if (taskrefresh == 'OUT')
				{
				document.getElementById("WebFormSpanTwo").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address_two + "\" target=\"" + web_form_target + "\" onMouseOver=\"WebFormTwoRefresH('IN');\"><IMG SRC=\"../agc/images/vdc_LB_webform_two_cn.gif\" border=0 alt=\"网页表单 2\"></a>\n";
				}
			else 
				{
				document.getElementById("WebFormSpanTwo").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address_two + "\" target=\"" + web_form_target + "\" onMouseOut=\"WebFormTwoRefresH('OUT');\"><IMG SRC=\"../agc/images/vdc_LB_webform_two_cn.gif\" border=0 alt=\"网页表单 2\"></a>\n";
				}
			}
		}
            //Modified by Kelvin End
...
// Send Hangup command for customer call connected to the conference now to Manager
	function dialedcall_send_hangup(dispowindow,hotkeysused,altdispo,nodeletevdac) 
		...
		//  DEACTIVATE CHANNEL-DEPENDANT BUTTONS AND VARIABLES
            ...
            //Modified by Kelvin Begin
			if (WebForm_Button_Display !='NONE' ) {
			document.getElementById("WebFormSpan").innerHTML = "<IMG SRC=\"../agc/images/vdc_LB_webform_OFF_cn.gif\" border=0 alt=\"网页表单\">";
			if (enable_second_webform > 0)
				{
				document.getElementById("WebFormSpanTwo").innerHTML = "<IMG SRC=\"../agc/images/vdc_LB_webform_two_OFF_cn.gif\" border=0 alt=\"网页表单 2\">";
				}
			}
            //Modified by Kelvin Begin
			document.getElementById("ParkControl").innerHTML = "<IMG SRC=\"../agc/images/vdc_LB_parkcall_OFF_cn.gif\" border=0 alt=\"保持电话\">";
			document.getElementById("HangupControl").innerHTML = "<IMG SRC=\"../agc/images/vdc_LB_hangupcustomer_OFF_cn.gif\" border=0 alt=\"挂断\">";
			if (VU_vicidial_transfers == '1'){
				document.getElementById("XferControl").innerHTML = "<IMG SRC=\"../agc/images/vdc_LB_transferconf_OFF_cn.gif\" border=0 alt=\"转接\">";
			}
			...
			document.getElementById("Leave3WayCall").innerHTML ="<IMG SRC=\"../agc/images/vdc_XB_leave3waycall_OFF_cn.gif\" border=0 alt=\"离开三方通话\" style=\"vertical-align:middle\">"; 
		}
...
// Send Hangup command for 3rd party call connected to the conference now to Manager
	function xfercall_send_hangup() 
		...
		//	document.getElementById("Leave3WayCall").innerHTML ="<IMG SRC=\"../agc/images/vdc_XB_leave3waycall_OFF_cn.gif\" border=0 alt=\"离开三方通话\">";
            ...
            if(Xfer_Dial_With_Customer_Display=='Y')
				{
			document.getElementById("DialWithCustomer").innerHTML ="<a href=\"#\" onclick=\"DialWithCustomerClick(1);return false;\"><IMG SRC=\"../agc/images/vdc_XB_dialwithcustomer_cn.gif\" border=0 alt=\"不挂断拨号\" style=\"vertical-align:middle\"></a>";
			    }
            
			document.getElementById("ParkCustomerDial").innerHTML ="<a href=\"#\" onclick=\"DialWithCustomerClick(0);return false;\"><IMG SRC=\"../agc/images/vdc_XB_parkcustomerdial_cn.gif\" border=0 alt=\"保持客户拨号\" style=\"vertical-align:middle\"></a>";
            //when project is ehsn image changed
            if(Fast_Hangup_Xferline_And_Grab_Custline=='N')
				{
			document.getElementById("HangupXferLine").innerHTML ="<IMG SRC=\"../agc/images/vdc_XB_hangupxferline_OFF_cn.gif\" border=0 alt=\"挂断第三方转接线\" style=\"vertical-align:middle\">";
				}
            else
				{
			document.getElementById("Leave3WayCall").innerHTML ="<IMG SRC=\"../agc/images/vdc_XB_leave3waycall_OFF_cn.gif\" border=0 alt=\"离开三方通话\" style=\"vertical-align:middle\">";
            document.getElementById("HangupXferLine").innerHTML ="<IMG SRC=\"../agc/images/vdc_XB_hangupxferline_OFF_cn_ehsn.gif\" border=0 alt=\"挂断第三方转接线\" style=\"vertical-align:middle\">";
				}
	
			document.getElementById("HangupBothLines").innerHTML ="<IMG SRC=\"../agc/images/vdc_XB_hangupbothlines_OFF_cn.gif\" border=0 alt=\"全部挂断\" style=\"vertical-align:middle\">";
			}
		    //Add by fnatic start
			//$("#TransferMainDIV").dialog("close");
			//Add by fnatic end
...
// Generate the Call Disposition Chooser panel
	function DispoSelectContent_create(taskDSgrp,taskDSstage)
		...
		var dispo_HTML = "<table cellpadding=5 cellspacing=5 width='100%'><tr><td bgcolor='#FEFBE2' style='border:1px solid #FEEB84;border-collapse:collapse;' height=300 width=240 valign=top>";
		var loop_ct = 0;
...
// Generate the 技能组代名 Chooser panel
	function GroupAliasSelectContent_create(task3way)
		...
		var Go_BacK_LinK = "<font size=3 style=\"BACKGROUND-COLOR: #FFFFCC\"><b><a href=\"#\" onclick=\"GroupAliasSelect_submit('');return false;\">回上一页</a>";
...
// open web form, then submit disposition
	function WeBForMDispoSelect_submit()
	    ...
	    //Mod by fnatic end
		document.getElementById("ParkCustomerDial").innerHTML ="<a href=\"#\" onclick=\"DialWithCustomerClick(0);return false;\"><IMG SRC=\"../agc/images/vdc_XB_parkcustomerdial_cn.gif\" border=0 alt=\"保持客户拨号\" style=\"vertical-align:middle\"></a>";
		document.getElementById("HangupBothLines").innerHTML ="<a href=\"#\" onclick=\"confirm_bothcall_send_hangup();return false;\"><IMG SRC=\"../agc/images/vdc_XB_hangupbothlines_cn.gif\" border=0 alt=\"全部挂断\" style=\"vertical-align:middle\"></a>";
	...
	function AgentsViewOpen(AVlocation,AVoperation)
		...
		if (AVoperation=='open')
			...
			if (AVlocation=='AgentViewSpan')
				...
				document.getElementById("AgentViewLink").innerHTML = "<a href=\"#\" onclick=\"AgentsViewOpen('AgentViewSpan','open');return false;\">查看话务员状态</a>";
		...
		if (resumevar != 'NO')
			...
			if (auto_dial_level == 0)
				...
				if (dial_method == "INBOUND_MAN")
					...
					if(Dial_Next_Display=='Y')
						{
					document.getElementById("DiaLControl").innerHTML = "<IMG SRC=\"../agc/images/vdc_LB_pause_OFF_cn.gif\" border=0 alt=\" 暂停 \"><a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADready');\"><IMG SRC=\"../agc/images/vdc_LB_resume_cn.gif\" border=0 alt=\"恢复\"></a><a href=\"#\" onclick=\"ManualDialNext('','','','','','0');\"><IMG SRC=\"../agc/images/vdc_LB_dialnextnumber_cn.gif\" border=0 alt=\"拨下一个号码\"></a>";
						}
					else
						{
					document.getElementById("DiaLControl").innerHTML = "<IMG SRC=\"../agc/images/vdc_LB_pause_OFF_cn.gif\" border=0 alt=\" 暂停 \"><a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADready');\"><IMG SRC=\"../agc/images/vdc_LB_resume_cn.gif\" border=0 alt=\"恢复\"></a>";					
  ...
  <TD class="banner_text_2" COLSPAN=4  VALIGN=TOP ALIGN=RIGHT style="background:url(../agc/images/logo_r1_c3.jpg); background-repeat:repeat-x;text-algin:left;">
    <b><span style="color:#FFFFFF; font-size:12px; font-family:Arial, Helvetica, sans-serif;" id="status">LIVE</span></b>&nbsp;
     <font class="banner_text">
      ...
      <?php	echo "<a href=\"#\" onclick=\"NormalLogout();return false;\">注销</a>\n"; ?><img src="../agc/images/logo_r1_c5.jpg" align="middle" />
    </font>
  </TD>
...
<!--<span style="position:absolute;left:15px;top:<?php echo $CBheight-60 ?>px;z-index:19;" id="VolumeControlSpan"><span id="VolumeUpSpan"><IMG SRC="../agc/images/vdc_volume_up_off.gif" BORDER=0></span><BR><span id="VolumeDownSpan"><IMG SRC="../agc/images/vdc_volume_down_off.gif" BORDER=0></span>
</font></span>-->
...
<span id="NeWManuaLDiaLBox">
   ...
   <!--搜索现有潜在客户-->
   <input style="visibility:hidden" type="checkbox" name="LeadLookuP" id="LeadLookuP" size="1" value="0">
   <input type="hidden" size="14" maxlength="20" name="MDDiaLOverridE" id="MDDiaLOverridE" class="cust_form" value="">
   <span id="ManuaLDiaLGrouPSelecteD"></span><span id="ManuaLDiaLGrouP"></span>
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
	   <td><input type='checkbox' name='manudial_dial_type' id='manudial_dial_type' title='勾选打内线' /> 拨打内线<!-- + fnatic 20110627 -->
 ...
 <table cellpadding="0" cellspacing="0" border="0" class="transfer_table" align="center">
  <!-- <tr>
   ...
   <fieldset>
    ...
    <div style="margin:2px 2px">
	 <input type="radio" name="btnTransferTarget" id="xferoverride" size="1" value="0" style="vertical-align:text-bottom" onClick="overrideclick()">外线号码
	...
	<div style="margin:4px 2px">
	 <input type="radio" name="btnTransferTarget" id="xferoverrideaaa" size="1" value="0" style="vertical-align:text-bottom" onClick="trasfertargetclick()">技能组
    ...
    <fieldset>
     ...
     <span STYLE="background-color: <?php echo $MAIN_COLOR ?>" id="DialWithCustomer">
	     <a href="#" onClick="DialWithCustomerClick(1);return false;">
		  ...
		  <IMG SRC="../agc/images/vdc_XB_dialwithcustomer_cn.gif" border=0 alt="不挂断拨号" style="vertical-align:middle">
		  <?php } ?>
		 </a>	</span>&nbsp;

    <span STYLE="background-color: <?php echo $MAIN_COLOR ?>" id="ParkCustomerDial">
	  <a href="#" onClick="DialWithCustomerClick(0);return false;">
	     <IMG SRC="../agc/images/vdc_XB_parkcustomerdial_cn.gif" border=0 alt="保持客户拨号" style="vertical-align:middle">	  </a>	</span>
   </fieldset>   </td>
  </tr>
   ...
   <td>
     <fieldset>
      ...
      <span STYLE="background-color: <?php echo $MAIN_COLOR ?>" id="HangupXferLine">
	   <!--when project is ehsn image changed-->
      <IMG SRC="../agc/images/vdc_XB_hangupxferline_OFF_cn_ehsn.gif" border=0 alt="挂断第三方转接线" style="vertical-align:middle">	  </span>    
     <span STYLE="background-color: <?php echo $MAIN_COLOR ?>" id="HangupBothLines">
	  
	     <IMG SRC="../agc/images/vdc_XB_hangupbothlines_OFF_cn.gif" border=0 alt="全部挂断" style="vertical-align:middle">	 </span>
    <span STYLE="background-color: <?php echo $MAIN_COLOR ?>" id="Leave3WayCall">
	  
	    <IMG SRC="../agc/images/vdc_XB_leave3waycall_OFF_cn.gif" border=0 alt="离开三方通话" style="vertical-align:middle">	</span>
  </fieldset>   </td>
  </tr>
 </table>
...
<div id="AgentViewSpanDIV">
 <span style="margin-bottom:5px; padding-bottom:5px; text-align:center;width:100%;border-bottom:1px solid #eee;">
	 用户组：<select name="AgentViewUsergroup" id="AgentViewUsergroup" style="width:170px;"><?php echo getAgentViewUsergroup($VD_login,$VD_campaign); ?></select>
	 技能组：<select name="AgentViewTechgroup" id="AgentViewTechgroup" style="width:170px;"><?php echo getAgentViewTechgroup($VD_campaign); ?></select>
 </span>
...
<span style="position:absolute;left:0px;top:0px;z-index:39;width:100%;" id="NoneInSessionBox">
    <table border=1 bgcolor="#CCFFFF" width=<?php echo $CAwidth ?> height=<?php echo $WRheight ?>><TR><TD align=center> 无人在这个会议中: <span id="NoneInSessionID"></span><BR>
	<a href="#" onClick="NoneInSessionOK();return false;">回上一页</a>
	<BR><BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:40;width:100%;" id="CustomerGoneBox">
	...
	<a href="#" onClick="CustomerGoneOK();return false;">回上一页</a>
	<BR><BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:43;width:100%;" id="AgenTDisablEBoX">
    <table border=1 bgcolor="#FFFFFF" width=<?php echo $CAwidth ?> height=<?php echo $WRheight ?>><TR><TD align=center>你的会话已不可用<BR><a href="#" onClick="LogouT('DISABLED');return false;">注销</a><BR><BR><a href="#" onClick="hideDiv('AgenTDisablEBoX');return false;">回上一页</a>
</TD></TR></TABLE>
</span>

<span style="position:absolute;left:0px;top:0px;z-index:44;width:100%;" id="SysteMDisablEBoX">
    <table border=1 bgcolor="#FFFFFF" width=<?php echo $CAwidth ?> height=<?php echo $WRheight ?>><TR><TD align=center>系统中有时间同步问题，请联系系统管理者<BR><BR><BR><a href="#" onClick="hideDiv('SysteMDisablEBoX');return false;">回上一页</a>
</TD></TR></TABLE>
</span>
...
<div id="DispoSelectBox">
	...
	<input type="checkbox" name="DispoSelectStop" id="DispoSelectStop" size=1 value="0"  onClick="change_pause_code(this);">暂停
	<BR>
...
<div id="CallBackSelectBox">
	...
	<a href="#" onClick="CallBackDatE_submit();return false;" style="font-size:14px;">确认</a><BR>
...
<span  style="position:absolute;left:172px;top:75px;z-index:30; text-align:left;" id="ScriptPanel">
   ...
   <table border=0 width="100%" cellspacing="0" cellpadding="0">
    <tr>
	 <td width="175px" align="center">
	  <IMG SRC="../agc/images/agc_live_call_OFF_cn.gif" NAME=livecall  WIDTH=109 HEIGHT=30 BORDER=0>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<span id="HangupControl"><IMG SRC="../agc/images/vdc_LB_hangupcustomer_OFF_cn.gif" border=0 alt="挂断"></span>
<span id="DiaLControl">
...
<BR>
<span id="ParkControl"><IMG SRC="../agc/images/vdc_LB_parkcall_OFF_cn.gif" border=0 alt="保持电话"></span>
<span id="XferControl"><?php if ($VU_vicidial_transfers == '1'){?><IMG SRC="../agc/images/vdc_LB_transferconf_OFF_cn.gif" border=0 alt="转接"><?php }?></span><BR>
<span id="DiaLLeaDPrevieW">
<?php if($Lead_Preview_Display=='Y'){?>
<input type=checkbox name=LeadPreview size=1 value="0">预览潜在客户
<?php } ?>
</span>
...
<span STYLE="background-color: #FFFFFF" id="WebFormSpan"><IMG SRC="../agc/images/vdc_LB_webform_OFF_cn.gif" border=0 alt="网页表单"></span>
<?php
if ($enable_second_webform > 0)
	{echo "<span STYLE=\"background-color: #FFFFFF\" id=\"WebFormSpanTwo\"><IMG SRC=\"../agc/images/vdc_LB_webform_two_OFF_cn.gif\" border=0 alt=\"网页表单 2\"></span>\n";}
?>
	...
	<td>
	 <span id="AgentViewLinkSpan">
	  <span id="AgentViewLink">
	   ...
	   <a href="#" onClick="AgentsViewOpen('AgentViewSpan','open');return false;">查看话务员状态</a>
	  </span>
	 </span>
	</td>
</tr>
...
<tr>
	...
	{echo "<a href=\"#\" onclick=\"alert_control('OFF');return false;\">关闭进线提示</a>";}
	else
	{echo "<a href=\"#\" onclick=\"alert_control('ON');return false;\">开启进线提示</a>";}
	?>
	</span>
	</td>
</tr>
...
<tr>
	...
	if ($view_calls_in_queue > 0)
		...
		if ($view_calls_in_queue_launch > 0) 
			{echo "<a href=\"#\" onclick=\"show_calls_in_queue('HIDE');\">隐藏队列通话</a>\n";}
		else 
			{echo "<a href=\"#\" onclick=\"show_calls_in_queue('SHOW');\">提取队列通话</a>\n";}
		}
	?>
	</span>   
	</td>
...
<tr>
	...
	<a href="#"  onclick="conf_channels_detail('SHOW');">显示通道信息</a>
	</span>   
	</td>
</tr>
<?php } ;?>
...
<table class="agent_info_table" border="0" cellspacing="0" cellpadding="0" width="100%">
 <tr>
  <td class="head" colspan=2>话务员帐号：<?php echo $VD_login;?>
  </td>
 </tr>
  <tr>
  <td class="head">分机号码：
...
function overrideclick(){
	document.getElementById("agentinput").innerHTML = '<input type="text" size="12"  maxlength="25" value="" style="margin-left:19px">';
...
function trasfertargetclick(){
	...
	if(Xfer_Blind_Display=='Y')
	{
		document.getElementById("DialBlindTransfer").innerHTML = "<a href=\"#\" onclick=\"mainxfer_send_redirect('XfeRLOCAL','" + lastcustchannel + "','" + lastcustserverip + "');return false;\"><IMG SRC=\"../agc/images/vdc_XB_blindtransfer_cn.gif\" border=0 alt=\"盲转\" style=\"vertical-align:middle\"></a>";
	}
...
function threeCall(){
	if(Fast_Hangup_Xferline_And_Grab_Custline=='N')
	{
		document.getElementById("HangupXferLine").innerHTML ="<a href=\"#\" onclick=\"confirm_xfercall_send_hangup();return false;\"><IMG SRC=\"../agc/images/vdc_XB_hangupxferline_cn.gif\" border=0 alt=\"挂断第三方转接线\" style=\"vertical-align:middle\"></a>";
    }
	else
	{
		document.getElementById("HangupXferLine").innerHTML ="<a href=\"#\" onclick=\"confirm_xfercall_send_hangup();return false;\"><IMG SRC=\"../agc/images/vdc_XB_hangupxferline_cn_ehsn.gif\" border=0 alt=\"挂断第三方转接线\" style=\"vertical-align:middle\"></a>";
	}
    document.getElementById("HangupBothLines").innerHTML ="<a href=\"#\" onclick=\"confirm_bothcall_send_hangup();return false;\"><IMG SRC=\"../agc/images/vdc_XB_hangupbothlines_cn.gif\" border=0 alt=\"全部挂断\" style=\"vertical-align:middle\"></a>";
	document.getElementById("Leave3WayCall").innerHTML ="<a href=\"#\" onclick=\"confirm_leave_3way_call();return false;\"><IMG SRC=\"../agc/images/vdc_XB_leave3waycall_cn.gif\" border=0 alt=\"离开三方通话\" style=\"vertical-align:middle\"></a>";
}
...
function vmclick(){
	...
	if(Xfer_Blind_Display=='Y')
	{
		document.getElementById("DialBlindTransfer").innerHTML = "<a href=\"#\" onclick=\"mainxfer_send_redirect('XfeRVMAIL','" + lastcustchannel + "','" + lastcustserverip + "');return false;\"><IMG SRC=\"../agc/images/vdc_XB_blindtransfer_cn.gif\" border=0 alt=\"盲转\" style=\"vertical-align:middle\"></a>";
	}
