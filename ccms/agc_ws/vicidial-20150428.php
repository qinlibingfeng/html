...
// GLOBAL FUNCTIONS
	function begin_all_refresh()
	    ...
	    startCall(phone);
 		...
 		socket.on('inbound', function (phone) {
	    console.log(phone);
...
<table class="agent_info_table" border="0" cellspacing="0" cellpadding="0" style="display:none">
 <tr>
  <td class="head" colspan=2><?php echo $lang_account; ?>：<?php echo $VD_login;?>
  </td>
 </tr>
  <tr>
  <td class="head"><?php echo $lang_phone_number; ?>：
  </td>
  <td><?php echo $SIP_user;?>
  </td>
 </tr>
