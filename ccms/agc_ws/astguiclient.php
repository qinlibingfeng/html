...
if( (strlen($user)<2) or (strlen($pass)<2) or (!$auth) or ($relogin == 'YES') )
	...
	echo "<TABLE><TR><TD></TD>\n";
	echo "<!-- ILPA -->\n";
echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  NOWRAP><a href=\"../agc_en/astguiclient.php?relogin=YES&user=$user&pass=$pass&phone_login=$phone_login&phone_pass=$phone_pass\">English <img src=\"../agc/images/en.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  BGCOLOR=\"#CCFFCC\" NOWRAP><a href=\"../agc_cn/astguiclient.php?relogin=YES&user=$user&pass=$pass&phone_login=$phone_login&phone_pass=$phone_pass\">简体中文 <img src=\"../agc/images/cn.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";	echo "</TR></TABLE>\n";
...
//			$password=strtoupper($pass);
		...
		if ($WeBRooTWritablE > 0)
			{
			fwrite ($fp, "CCMS|GOOD|$date|$user|$pass|$ip|$browser|$LOGfullname|\n");
			fclose($fp);
			}
		}
	else
		...
		if ($WeBRooTWritablE > 0)
			{
			fwrite ($fp, "CCMS|FAIL|$date|$user|$pass|$ip|$browser|$LOGfullname|\n");
			fclose($fp);
			}
		}
	}
...
{
echo "<title>astGUIclient web client: 分机号码</title>\n";
echo "</head>\n";
echo "<BODY BGCOLOR=WHITE MARGINHEIGHT=0 MARGINWIDTH=0>\n";
echo "<TABLE><TR><TD></TD>\n";
echo "<!-- ILPA -->\n";
...
echo "<BR><BR><BR><CENTER><TABLE WIDTH=360 CELLPADDING=0 CELLSPACING=0 BGCOLOR=\"#CCC2E0\"><TR BGCOLOR=WHITE>";
echo "<TD ALIGN=LEFT VALIGN=BOTTOM><IMG SRC=\"../agc/images/agc_tab_astguiclient.gif\" BORDER=0></TD>";
echo "<TD ALIGN=CENTER VALIGN=MIDDLE> 分机号码 </TD>";
echo "</TR>\n";
echo "<TR><TD ALIGN=LEFT COLSPAN=2><font size=1> &nbsp; </TD></TR>\n";
echo "<TR><TD ALIGN=RIGHT>分机号码: </TD>";
echo "<TD ALIGN=LEFT><INPUT TYPE=TEXT NAME=phone_login SIZE=10 maxlength=20 VALUE=\"$phone_login\"></TD></TR>\n";
...
?>
	...
	image_voicemail_OFF.src="../agc/images/agc_check_voicemail_OFF_cn.gif";
	var image_voicemail_ON = new Image();
	image_voicemail_ON.src="../agc/images/agc_check_voicemail_ON_cn.gif";
	var image_voicemail_BLINK = new Image();
	image_voicemail_BLINK.src="../agc/images/agc_check_voicemail_BLINK_cn.gif";
...
// ################################################################################
// Send Originate command for local dial to 经理sends phone name where call is going to
	...
	function liverecording_send_recording(taskvar,taskchan,taskspan,taskfile) 
		...
		if (xmlhttp) 
			...
			if (taskvar == 'Monitor')
				...
				var rec_start_html = "<a href=\"#\" onclick=\"liverecording_send_recording('StopMonitor','" + monitorchannelvalue + "','" + taskspan + "','" + filename + "');return false;\">停止录音";
			...
			if (taskvar == 'StopMonitor')
				...
				filename = taskfile;
				var rec_stop_html = "<a href=\"#\" onclick=\"liverecording_send_recording('Monitor','" + monitorchannelvalue + "','" + taskspan + "','');return false;\">录音";
	...
	function conf_send_recording(taskconfrectype,taskconfspan,taskconfrec,taskconffile) 
		...
		if (xmlhttp) 
			...
			if (taskconfrectype == 'MonitorConf')
				...
				var conf_rec_start_html = "<a href=\"#\" onclick=\"conf_send_recording('StopMonitorConf','" + taskconfspan + "','" + taskconfrec + "','" + filename + "');return false;\">停止录音</a>";
			...
			if (taskconfrectype == 'StopMonitorConf')
				...
				var channelrec = "Local/" + taskconfrec + "@" + ext_context;
				var conf_rec_start_html = "<a href=\"#\" onclick=\"conf_send_recording('MonitorConf','" + taskconfspan + "','" + taskconfrec + "','');return false;\">录音</a>";
				document.getElementById(taskconfspan).innerHTML = conf_rec_start_html;
				}
		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	pause();
					...
					if (live_calls > 0)
						{
						var live_calls_HTML = "<font face=\"Arial,Helvetica\"><B>通话号码清单:</B></font><BR><table width=100%><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\">进端通道</td><td><font class=\"log_title\">远程通道</td><td><font class=\"log_title\">RECORD</td><td><font class=\"log_title\">挂断</td><td><font class=\"log_title\"转接</td><td><font class=\"log_title\">停泊</td></tr>";
						...
						while (loop_ct < live_calls)
							...
							if (recLIST.match(regx)) 
								{live_calls_HTML = live_calls_HTML + "<span id=\"recordlive" + loop_ct + "\"><a href=\"#\" onclick=\"liverecording_send_recording('StopMonitor','" + channelfieldBtrunk_array[1] + "','recordlive" + loop_ct + "');return false;\">停止录音</span>";}
							else 
								{live_calls_HTML = live_calls_HTML + "<span id=\"recordlive" + loop_ct + "\"><a href=\"#\" onclick=\"liverecording_send_recording('Monitor','" + channelfieldBtrunk_array[1] + "','recordlive" + loop_ct + "');return false;\">录音</span>";}

							live_calls_HTML = live_calls_HTML + "</td><td><font class=\"log_text\"><a href=\"#\" onclick=\"livehangup_send_hangup('" + channelfieldBtrunk_array[1] + "');return false;\">挂断</td><td><font class=\"log_text\"><a href=\"#\" onclick=\"showMainXfeR('MainXfeRBox','" + channelfieldBtrunk_array[1] + "','" + channelfieldA_array[1] + "');return false;\"转接</a></td><td><font class=\"log_text\"><a href=\"#\" onclick=\"mainxfer_send_redirect('ParK','" + channelfieldBtrunk_array[1] + "');return false;\">停泊</td></tr>";
		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	alert(xmlhttp.responseText);
					...
					if (out_calls > 0)
						{
						var out_log_HTML = "<table width=580><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\"> 通话日期\/时间</td><td><font class=\"log_title\">号码</td><td align=right><font class=\"log_title\">LENGTH (M:SS)</td><td><font class=\"log_title\"> </td></tr>"
					...
					if (in_calls > 0)
						{
						var in_log_HTML = "<table width=580><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\"> 通话日期\/时间</td><td><font class=\"log_title\">IN-NUMMER</td><td COLSPAN=2><font class=\"log_title\">CALLERID</td><td align=right><font class=\"log_title\">LENGTH</td><td><font class=\"log_title\"> </td></tr>"
		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	alert(xmlhttp.responseText);
					...
					if (parked_count > 0)
						{
						var park_HTML = "<table width=600><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\">CHANNEL<BR>&nbsp; 拨号 ID</td><td><font class=\"log_title\">停泊ED BY<BR>&nbsp; 停泊时间</td><td><font class=\"log_title\">挂断</td><td><font class=\"log_title\"转接</td><td><font class=\"log_title\">接起</td></tr>"
...
// display general conference meetme room header info and refresh detail content
	function conference_header_display(taskconf,taskreg,taskrefresh)
		...
		var conf_head_HTML = "<font class=\"sh_text\">会议 " + head_conf + "</b></font><font class=\"sb_text\">&nbsp; &nbsp; 注册至: " + head_reg + " &nbsp; " + reglink + " &nbsp; &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"basic_originate_call('" + head_conf + "','NO','NO');return false;\">进入电话会议 </a><BR><a href=\"#\" onclick=\"check_for_conf_calls('" + head_conf + "','1');return false;\">刷新 </a> &nbsp; &nbsp; <span id=\"conf_rec_link\"><a href=\"#\" onclick=\"conf_send_recording('MonitorConf','conf_rec_link','" + head_conf + "');return false;\">录音</a></span> &nbsp; &nbsp; &nbsp; &nbsp; <input TYPE=TEXT SIZE=15 NAME=conf_dtmf STYLE=\"font-family : sans-serif; font-size : 10px\"> <A HREF=\"#\" onclick=\"SendConfDTMF(" + head_conf + ");\">传送 DTMF</A> &nbsp; &nbsp; &nbsp; &nbsp; <input TYPE=TEXT SIZE=15 NAME=conf_dial STYLE=\"font-family : sans-serif; font-size : 10px\"> <A HREF=\"#\" onclick=\"SendManualDial('YES'," + head_conf + ");\">由电话会议中拨号</A><BR></font>";
				...
				//	alert(xmlhttp.responseText);
					...
					var conf_chan_array = check_conf_array[1].split(" ~");
					   if (live_conf_calls > 0)
						...
						var conv_start=-1;
						var live_conf_HTML = "<font face=\"Arial,Helvetica\"><B>多方通话中的参与号码:</B></font><BR><TABLE WIDTH=500><TR BGCOLOR=#E6E6E6><TD><font class=\"log_title\">#</TD><TD><font class=\"log_title\">远程通道</TD><TD><font class=\"log_title\">挂断</TD><TD><font class=\"log_title\"转接</TD></TR>";
...
// ################################################################################
// Send Originate command to manager to direct user to 语音信箱
...
//('BuilD','ADD','REMOVE','UP','DOWN')
	...
	//		alert(favorites_listEDIT);
		...
		var favedit_HTML = "<center><table cellpadding=5 cellspacing=5 width=750><tr><td colspan=2 align=center bgcolor=\"#DDDD99\"><B>有空闲的分机</B></td><td align=center bgcolor=\"#CCCC99\"><B> 我的最爱</B></td></tr><tr><td bgcolor=\"#DDDD99\" height=380 width=200 valign=top><font class=\"ss_text\"><span id=FavSelectA>";
		loop_ct = 0;
...
<?php	echo "欢迎 $LOGfullname, 您已登入此分机: $fullname - $protocol/$extension on $server_ip &nbsp; <a href=\"#\" onclick=\"LogouT();return false;\">注销</a><BR>\n"; ?>
</TD></TR>
<TR VALIGN=TOP ALIGN=LEFT>
<TD><A HREF="#" onclick="MainPanelToFront();"><IMG SRC="../agc/images/agc_tab_main_cn.gif" ALT="主控台" WIDTH=83 HEIGHT=30 BORDER=0></A></TD>
<TD><A HREF="#" onclick="ActiveLinesPanelToFront();"><IMG SRC="../agc/images/agc_tab_active_lines_cn.gif" ALT="现行线路控制台" WIDTH=139 HEIGHT=30 BORDER=0></A></TD>
<TD><A HREF="#" onclick="ConfereNcesPanelToFront();"><IMG SRC="../agc/images/agc_tab_conferences_cn.gif" ALT="电话会议控制台" WIDTH=139 HEIGHT=30 BORDER=0></A></TD>
<TD><A HREF="#" onclick="SendCheckVoiceMail();"><IMG SRC="../agc/images/agc_check_voicemail_ON_cn.gif" NAME=voicemail ALT="检视语音信箱" WIDTH=170 HEIGHT=30 BORDER=0></A></TD>
<TD><IMG SRC="../agc/images/agc_live_call_OFF_cn.gif" NAME=livecall ALT="通话中电话" WIDTH=109 HEIGHT=30 BORDER=0></TD>
</TR></TABLE>
</SPAN>
...
<span style="position:absolute;left:0px;top:12px;z-index:29;" id="TrunkHangupBox">
	...
	<span id="TrunkHangup_HUlink"><a href="#" onclick="busyhangup_send_hangup('Trunk');return false;">挂断 Trunk</a> &nbsp; | &nbsp; </span>
	<span id="TrunkHangup_HJlink"><a href="#" onclick="busyhangup_send_redirect('Trunk','HIJACK');return false;">介入 Trunk</a> &nbsp; | &nbsp; </span>
	<span id="TrunkHangup_ZMlink"><a href="#" onclick="busyhangup_send_redirect('Trunk','LISTEN');return false;">监听 Trunk</a> &nbsp; | &nbsp; </span>
	<a href="#" onclick="busytrunkhangup_force_refresh();return false;">刷新</a> &nbsp; | &nbsp; 
	<a href="#" onclick="hideTrunkHangup('TrunkHangupBox');">回主界面</a>
	</TD></TR></TABLE>
</span>

<span style="position:absolute;left:0px;top:12px;z-index:28;" id="LocalHangupBox">
    <table border=1 bgcolor="#CDE0C2" width=600 height=500><TR><TD> LOCAL 挂断 <BR><BR>
	<span id="LocalHangupContent"> 启用Local画面 </span><BR>
	<span id="LocalHangup_HUlink"><a href="#" onclick="busyhangup_send_hangup('Local');return false;">挂断 Local</a> &nbsp; | &nbsp; </span>
	<span id="LocalHangup_HJlink"><a href="#" onclick="busyhangup_send_redirect('Local');return false;">介入 Local</a> &nbsp; | &nbsp; </span>
	<span id="LocalHangup_ZMlink"><a href="#" onclick="busyhangup_send_redirect('Local','LISTEN');return false;">监听 Local</a> &nbsp; | &nbsp; </span>
	<a href="#" onclick="busylocalhangup_force_refresh();return false;">刷新</a> &nbsp; | &nbsp; 
	<a href="#" onclick="hideLocalHangup('LocalHangupBox');">回主界面</a>
	</TD></TR></TABLE>
</span>
...
<span style="position:absolute;left:80px;top:12px;z-index:42;" id="MainXfeRBox">
    ...
    <table border=0 bgcolor="#FFFFCC" width=600 height=500 cellpadding=3><TR><TD COLSPAN=3 ALIGN=CENTER><b> 来电转接</b> <BR>通话已被转接: <span id="MainXfeRChanneL">Channel</span><BR></tr>
	<tr><td>分机:<BR><span id="MainXfeRContent"> 分机表 </span></td>
	<td>
	<BR>
	<a href="#" onclick="mainxfer_send_redirect('XfeR');return false;">传送给所选分机</a> <BR><BR>
	<a href="#" onclick="mainxfer_send_redirect('VMAIL');return false;">传送给所选语音信箱</a> <BR><BR>
	<a href="#" onclick="mainxfer_send_redirect('ENTRY');return false;">传送至该号码</a>:<BR><input type=text name=extension_xfer_entry size=20 maxlength=50> <BR><BR>
	<a href="#" onclick="getactiveext('MainXfeRBox');return false;">刷新</a> <BR><BR><BR>
	<a href="#" onclick="hideMainXfeR('MainXfeRBox');">回主界面</a> <BR><BR>
	</TD>
	<TD>会议:<BR><font size=1>(点选号码以送出会议邀请n)<BR><input type=checkbox name=MainXfeRconfXTRA size=1 value="1"> 传送我的通道<div class="scroll_list" id="MainXfeRconfContent"> 电话会议功能 </div></td></TR></TABLE>
</span>

<span style="position:absolute;left:80px;top:12px;z-index:43;" id="LocalDialBox">
    <table border=0 bgcolor="#FFFFCC" width=600 height=500 cellpadding=3><TR><TD COLSPAN=3 ALIGN=CENTER><b> 拨给LOCAL分机</b> <BR>电话来源: <span id="LocalDialChanneL">Channel</span><BR></tr>
	<tr><td>分机:<BR><span id="LocalDialContent"> 分机表 </span></td>
	<td>
	<BR>
	<a href="#" onclick="mainxfer_send_originate('DiaL','','');return false;">拨打所选分机</a> <BR><BR>
	<a href="#" onclick="mainxfer_send_originate('VMAIL');return false;">拨打所选语音信箱</a> <BR><BR>
	<a href="#" onclick="getactiveext('LocalDialBox');return false;">刷新</a> <BR><BR><BR>
	<a href="#" onclick="hideLocalDial('LocalDialBox');">回主界面</a> <BR><BR>
	</TD>
	<TD></td></TR></TABLE>
</span>

<span style="position:absolute;left:40px;top:12px;z-index:41;" id="ParkDisplayBox">
    <table border=0 bgcolor="#FFFFCC" width=640 height=500 cellpadding=3><TR><TD COLSPAN=3 ALIGN=CENTER><b> 停泊电话:</b> <div class="scroll_park" id="ParkDisplayContents"></div>
	<a href="#" onclick="hideParkDisplay('ParkDisplayBox');">回主界面</a> <BR><BR>
	</td></TR></TABLE>
</span>
...
<tr><td align=center><font face="Arial,Helvetica"><B>语音信箱 &nbsp; &nbsp; </B></font> 新: <span id="new_vmail_span"></span> &nbsp; &nbsp; 旧: <span id="old_vmail_span"></span> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <font face="Arial,Helvetica"><B>人工拨号 &nbsp; &nbsp; &nbsp; </B></font><input TYPE=TEXT SIZE=20 NAME=manual_dial STYLE="font-family : sans-serif; font-size : 10px"> <A HREF="#" onclick="SendManualDial();">DIAL</A></td></tr>

<tr><td align=center><a href="#" onclick="showParkDisplay('ParkDisplayBox');return false;"><font face="Arial,Helvetica"><B>停泊电话</B></a>:  <span id="parked_calls_count">0</span> &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="#" onclick="showLocalDial('LocalDialBox');return false;"><font face="Arial,Helvetica"><B>LOCAL拨打分机</a></td></tr>

<tr><td align=center><font face="Arial,Helvetica"><B>外拨电话:</B></font></td></tr>
<tr><td align=center><div class="scroll_log" id="outboundcallsspan"></div></td></tr>
<tr><td align=center><font face="Arial,Helvetica"><B>进线电话:</B></font></td></tr>
...
<span style="position:absolute;left:640px;top:0px;z-index:33;" id="FavoriteSBox">
    <table border=0 bgcolor="#DDDDFF" width=200 height=400 cellpadding=2 ALIGN=TOP><TR><TD align=center><span id="FavoriteSContent"><font class="sh_text"> 我的最爱</font><font class="sb_text"> &nbsp; &nbsp; &nbsp; <a href="#" onclick="favorites_editor('BuilD');return false;"> 编辑</a></span></TD></TR>
<?php
	$h=0;
	while ($favorites_count > $h)
	{
...
<span style="position:absolute;left:5px;top:5px;z-index:34;" id="FavoriteSEdiT">
    <table border=0 bgcolor="#DDDDFF" width=800 height=450 cellpadding=2 ALIGN=TOP><TR HEIGHT=95%><TD align=center HEIGHT=95%><span id="FavoriteSEditContent"> 我的最爱</span></TD></TR>
	<TR><TD ALIGN=CENTER><BR> &nbsp; </TD></TR>
	<TR VALIGN=BOTTOM><TD VALIGN=BOTTOM ALIGN=CENTER BGCOLOR="#FFFFCC"><a href="#" onclick="SubmiT_FavoritE_ChangEs();return false;">确认送出我的最爱变更 - 需要注销</a></TD></TR>
	<TR VALIGN=BOTTOM><TD VALIGN=BOTTOM ALIGN=CENTER BGCOLOR="#FFFFCC"><a href="#" onclick="hideDiv('FavoriteSEdiT');return false;">回到主界面 - 忽略变更</a></TD></TR>
	</TABLE>
</span>
...
<tr><td colspan=3>
<a href="#" onclick="pause();return false;">STOP</a> | <a href="#" onclick="start();return false;">START</a> &nbsp; &nbsp; 更新比例: <span id="refresh_rate">1000 ms</span> <a href="#" onclick="faster();return false;">较快速</a> | <a href="#" onclick="slower();return false;">较慢速</a></p>
...
<tr><td VALIGN=TOP>
	<span id="activeext"><em>资料至此</em></span><BR><BR>
</td><td VALIGN=TOP>
	<span id="busytrunk"><em>资料至此</em></span><BR><BR><span id="TrunkHangupLink"><a href="#" onclick="showTrunkHangup('TrunkHangupBox');return false;">Trunk 活动</a></span>
</td><td VALIGN=TOP>
	<span id="busyext"><em>资料至此</em></span><BR><BR><span id="LocalHangupLink"><a href="#" onclick="showLocalHangup('LocalHangupBox');return false;">Local 活动</a></span>
</td></tr>
...
<span id="ConfereNcesListContent">电话会议列表 </span>
</span>
...
<span style="width:540;height:400;" id="ConfereNceDetailContent">点选会议室左方可浏览相关信息 </span>
</span>
