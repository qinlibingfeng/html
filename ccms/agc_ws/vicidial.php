...
// Finish the wrapup timer early
	...
	function RecordList(){		
		var record_address = "../CallCenter/index.php/report/communicate/"+user;
		$("#webaddress").attr("src",record_address);
		$("#dialog-confirm").dialog(
		{	
			title:'录音查询',	
			width:1024,
	...
	function MessageList(){		
		var message_address = "../CallCenter/index.php/report/leavemess/"+user;
		$("#webaddress").attr("src",message_address);
		$("#dialog-confirm").dialog(
		{				
			title:'留言查询',				     
			width:1024,
	...
	function RecordDown(){		
		var record_address = "../record_down/RecordSet_Count.php";
...
// GLOBAL FUNCTIONS
	...
	socket.on('outbound', function (phone) {
	  ...
	  socket.on('recordlist', function (agent) {
	    RecordList();

	  });

	  socket.on('messagelist', function (agent) {
	    MessageList();
	...
	function agent_grab_line2(){
		...
		if (xmlhttp) 
			{ 
			RAview_query = "server_ip=" + server_ip + "&session_name=" + session_name + "&ACTION=agent_grab_line2&format=text&user=" + window.user + "&pass=" + pass + "&conf_exten=" + session_id + "&extension=" + extension + "&protocol=" + protocol + "&campaign=" + campaign + "&stage=100%";
			xmlhttp.open('POST', 'vdc_db_query.php'); 
			xmlhttp.setRequestHeader('Content-Type','application/x-www-form-urlencoded; charset=UTF-8');
			xmlhttp.send(RAview_query); 
			xmlhttp.onreadystatechange = function() 
...
<span position:absolute;left:0px;top:0px;z-index:43;width:100%;" id="AgenTDisablEBoX">
...
<span id="CallbacksButtons"></span><span id="CBstatusSpan"><a href="#" onClick="CalLBacKsLisTCheck();return false;"><IMG SRC="../agc/images/cn/lgq_ss_callback.gif" BORDER=0></a></span>
<span id="RecordSpan"><a  href="#" onClick="RecordList();return false;"><IMG SRC="../agc/images/cn/lgq_ss_Record.gif" BORDER=0></a></span>
<span id="MessageSpan"><a  href="#" onClick="MessageList();return false;"><IMG SRC="../agc/images/cn/lgq_ss_leavemessage.gif" BORDER=0></a></span>


<span id="RecordSpan"><a  href="#" onClick="RecordDown();return false;">录音下载</a></span>
...
<iframe id="webaddress" src="" width="100%" height="100%"></iframe>
</div> 

<div id="dialog-confirm-record" title="录音下载" style="display:none">
<iframe id="recordaddress" src="" width="100%" height="100%"></iframe>
</div> 
</body>
</html>
