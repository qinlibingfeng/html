...
//	var attempt_delay = document.getElementById("attempt_delay").value;
	...
	var limit_used_leads = document.getElementById("limit_used_leads").value;
...
<!--
	...
	.font_left2{ color:#F47621; font-weight:bold; padding-right:8px; font-size:14px; border-bottom:solid 1px #eee;}
	.font_date2{ text-align:right; font-weight:bold; padding-right:8px; font-size:14px; border-bottom:solid 1px #eee;}
	.font_calls2{ text-align:right; font-weight:bold; padding-right:5px; line-height:28px; font-size:18px; color:#F47621;}
...
<table width=90% border=0 id="forecast_outbound_handle_config_table" style="display:block"  align="center">
...
<!-- end add -->
	<tr>
		<td  align=right class="font_calls2"><br>System Config:</td>
	</tr>
	<tr>
		<td  align=right class="font_date2"><br>Campaign:</td>
		<td  class="font_left2"><br><?php echo $campaign_id;?> - <?php echo $campaign_name;?></td>
		<td  class="font_left"><br></td>
		<td  class="font_left"><br></td>
	</tr>
	<tr>
	...
	<td align=right>最低可拨打Lead百分比：</td>
	<td><input type=text id="limit_used_leads" value="<?php echo $limit_used_leads;?>" />&nbsp;<a href="javascript:openNewWindow('admin.php?ADD=99999#sys_conf_limit_used_leads')"><img height="20" border="0" align="TOP" width="20" alt="HELP" src="help.gif"></a><!--add by pie 20130508--></td>
	</tr>
	<tr>
		<td>　</td>
	</tr>
