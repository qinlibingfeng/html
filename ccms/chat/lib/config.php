...
$config['dbConnection']['pass'] = 'anlaigz';
$config['dbConnection']['name'] = 'vicidial';
$config['dbConnection']['type'] = 'mysql';
$config['dbConnection']['link'] = null;

$config['dbvicidial'] = array();
$config['dbvicidial']['host'] = 'localhost';
$config['dbvicidial']['user'] = 'root';
$config['dbvicidial']['pass'] = 'anlaigz';
$config['dbvicidial']['name'] = 'vicidial';
$config['dbvicidial']['type'] = 'mysql';
$config['dbvicidial']['link'] = null;
// Database table names:
$config['dbTableNames'] = array();
$config['dbTableNames']['online']		= 'ajax_chat_online';
$config['dbTableNames']['messages']		= 'ajax_chat_messages';
$config['dbTableNames']['messages_user']		= 'ajax_chat_messages_user';
...
$config['sessionCookieLifeTime'] = 3650;
