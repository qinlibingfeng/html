...
if($report_name != "summary"){
	if ( $sumreport == "N" ){
	   ...
	   echo "<li><a href=\"#\" class=\"top\" onclick=\"testopenDiv('forecast_outbound_handle_config_table');\"><img src=new_style/images/settings.png border=0 style='vertical-align:middle;'/>参 数</a></li>";
	}   
}
...
<table width=90% border=0 id="forecast_outbound_handle_config_table" style="display:none"  align="center">
		<td><a href="#" class="set_title" onclick="closetestopenDiv('forecast_outbound_handle_config_table');"><img src=new_style/images/settings.png border=0 style='vertical-align:middle;'/><font color="FF0000">关闭参数设置</font></a></td>
<!--
</table>
<br><br>
...
<!---end edit-->
	...
	<tr>
		<td align=right><input type=checkbox id="auto_dial_level_checkbox" name="auto_dial_level_checkbox" <?php echo $auto_dial_level_checkbox_checked;?> onclick=checked_auto_dial_level_checkbox(1) />系统自动调整拨号级别</td>
		<td>　</td> 
	...
	<tr>
		...
		<td><input type=text id="drop_call_seconds" name="drop_call_seconds" id="drop_call_seconds" value="<?php echo $drop_call_seconds;?>" /></td>
		<td align=right>最短提前派Call时长(S):</td>
		<td><input type=text id="shortest_time_send_call" value="<?php echo $shortest_time_send_call;?>"/>(0为关闭)</td>
	</tr>
	<tr>
		<td align=right>ACW状态保持时长(S):</td>
		<td><input type=text id="acw_hold_time" value="<?php echo $acw_hold_time;?>"/></td>
		<td align=right>外拨派Call时长:</td>
		<td><input type=text id="wait_time_for_connet_agent" value="<?php echo $wait_time_for_connet_agent;?>" /></td>
	</tr>
	<tr>
		<td>　</td>
	</tr>
	...
	<tr>
		...
		<td><input type=text id="max_abandon_rate" value="<?php echo $max_abandon_rate;?>"/></td>
		<td align=right>目标平均等待时间(S):</td>
		<td><input type=text id="max_wait_time" value="<?php echo $max_wait_time;?>" /></td>
	</tr>
	<tr>
