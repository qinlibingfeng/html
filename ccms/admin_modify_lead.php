...
# 
# CCMS database administration modify lead in vicidial_list
# admin_modify_lead.php
#
...
# 70424-1128 - Added campaign-specific Call Result, reformatted recordings list
...
#		echo "<a href=\"$PHP_SELF\">Close this window</a>\n<BR><BR>\n";
	...
	echo "$statuses_list";
	echo "</select> <i>(with $log_campaign Call Result)</i></td></tr>\n";


	echo "<tr bgcolor=#B6D3FC><td align=left>Modify CCMS log </td><td align=left><input type=checkbox name=modify_logs value=\"1\" CHECKED></td></tr>\n";
