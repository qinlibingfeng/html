...
$stmt="SELECT count(*) from vicidial_users where user='$PHP_AUTH_USER' and pass='$PHP_AUTH_PW' and user_level >= 5 and view_reports='1' and modify_servers='1';";
if ($DB) {echo "|$stmt|\n";}
