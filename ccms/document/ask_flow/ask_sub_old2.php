...
.ask_cutline{border: 1px solid #D2D2D2;background: #E4EDFC;margin-top: 10px;padding:2px 6px 2px 6px;*padding:4px 6px 2px 6px;font-size: 12px;font-weight: bold;position: relative;zoom:1;color:#666;/*#329900*/text-align: left;border-radius:3px;}
				...
				switch(con.que_type){
					case "radio":
					 ...
					 $.each(con.form_list, function(f_i,con_f){
						 if(con_f.do_func=="y"){
							 form_input="&nbsp;<input type='text' size='36' class='inputText' name='ask_"+con.que_id+"[]' id='ask_"+con_f.form_id+"_"+f_i+"_text' disabled />";
						 }else{
							 form_input="";
						 }
					...
					case "text":
					 ...
					 que+="<input type='text' size='36' class='inputText' name='ask_"+con.que_id+"' size='"+con.form_size+"' style='"+input_size+"'>";
