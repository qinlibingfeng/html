...
//数据库连接
$db_host = "172.17.247.254";
$db_server_ip = "172.17.247.254";
...
//管理后台地址
$admin_server_home = "http://172.17.247.254/default.php";

//AGC后台地址
$agc_server_home = "http://172.17.247.254/agc_cn/vicidial.php";
...
if($sys_os=="centos"){
 	...
 	$record_ip="http://172.17.247.254/RECORDINGS/";
	$record_web="http://172.17.247.254/records/";
