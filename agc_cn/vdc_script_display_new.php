...
$stmt = "SELECT use_non_latin,timeclock_end_of_day,agentonly_callback_campaign_lock,vdc_header_phone_format FROM system_settings;";
$rslt=mysqli_query($db_conn,$stmt);
if ($DB) {echo "$stmt\n";}
...
//if(ereg("^US_DASH",$vdc_header_phone_format)){$phone_number=format_phone($phone_number);}
...
$script_text = eregi_replace('--A--phone_number--B--',"<span class='f_p_n'>$phone_number</span>",$script_text);
...
$(document).ready(function(){
   ...
   if(regUS_DASHphone.test(vdc_header_phone_format)){
		...
		$("#script_text .f_p_n").each(function(){
...
echo "<div class=\"page_main\" style=\"background-attachment:fixed\">";
echo "  <table width=\"99%\" border=\"0\" align=\"center\" cellpadding=\"0\" class=\"blocktable\" >\n";
echo "    <tr>\n";
echo "      <td align=\"left\" valign=\"top\">\n";
echo "<br/><center><h5>$script_name</h5><br/></center>\n";
echo "<div style='font-size:14px' id='script_text'>$script_text</div>\n";
echo "		</td>\n";
echo "    </tr>\n";
echo "  </table>\n";
echo "</div> \n";
