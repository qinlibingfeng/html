               ...
               <tr>
                 ...
                 <td>
                   ...
                   <select name="data_type" id="data_type" class="s_option">
                    <option style="display:none" value="data_5" chart_x="工号、姓名" title="按工号统计" selected="selected">按工号统计</option>
                    <option style="display:none" value="data_6" chart_x="坐席组" title="按坐席组统计">按坐席组统计</option>
                    <option style="display:none" value="data_1" chart_x="日期" title="按日期统计">按日期统计</option>
                    <option selected = "selected" value="data_12" chart_x="工号、日期" title="按日期统计">按工号、日期统计</option>
                    <option style="display:none" value="data_2" chart_x="日期" title="按周统计">按周统计</option>
                    <option style="display:none" value="data_22" chart_x="工号、日期" title="按周统计">按工号、周统计</option>
                    <option style="display:none" value="data_3" chart_x="月份" title="按月份统计">按月份统计</option>
                    <option style="display:none" value="data_32" chart_x="工号、月份" title="按月份统计">按工号、月份统计</option>
                    <option style="display:none" value="data_4" chart_x="业务" title="按业务统计">按业务统计</option>
                    <option style="display:none" value="data_42" chart_x="工号、业务" title="按业务统计">按工号、业务统计</option>
