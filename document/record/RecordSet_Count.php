            ...
            <form action="" onSubmit=""  method="post" name="form1" id="form1">       
             <table width="100%" border="0" align="center"  cellspacing="0" id="search_list" class="search_table" >
               ...
               <tr>
                 ...
                 <td style="display:none" width="8%"  align="right" id="">文件名称：</td>
                     <td style="display:none"  nowrap="nowrap">
                        <select name="record_type" class="s_option" id="record_type" >
                            <option value="user_yymmdd_hhmiss_user_phone" selected="selected" title="年月日_号码_工号.wav">年月日_号码_工号.wav</option>
               ...
               <tr>
				 ...
				 <select name="campaign_id" class="campaign_id" id="campaign_id" >
                    <option value="IVR_AIA" selected="selected" title="呼入">呼入</option>
                    <option value="vicitest" title="呼出">呼出</option></select>
